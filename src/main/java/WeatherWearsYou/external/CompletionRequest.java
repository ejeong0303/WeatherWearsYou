...
public record CompletionRequest(String model, String prompt, double temperature, int max_tokens) {
    ...
    public static CompletionRequest defaultWith(String[] words) {

        String prompt = String.format("Give me a word(don't describe with adjectives or colors) for each category " +
                        ...
                        "Give me only the list, don't tell me additional notes.",
